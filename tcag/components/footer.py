            ...
            rx.el.footer(
                rx.vstack(
                    rx.vstack(
                        ...
                        rx.text("Email:  info@tcaglifesciences.com", size="3", weight="bold", color="black", text_align="center"),
                        rx.text("Phone: +91-80913 66601", size="3", weight="bold", color="black", text_align="center"),
                        spacing="3",
                        align_items="center",
                        width="100%",
                    ),
